...
parser.add_argument("--base_channels", default=128, type=int, dest="base_channels")
parser.add_argument("--channel_mults", default=(1,2,2,2), type=tuple, dest="channel_mults")
parser.add_argument("--num_res_blocks", default=2, type=int, dest="num_res_blocks")
parser.add_argument("--time_emb_dim", default=128*4, type=int, dest="time_emb_dim")
...
parser.add_argument("--log_rate", default=1000, type=int, dest="log_rate")
