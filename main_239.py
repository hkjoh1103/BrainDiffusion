...
parser.add_argument("--age_type", default='int', choices=['int', 'cat', 'pos'], type=str, dest="mri_type")
...
if args.mri_type == 'adc':
    args.data_dir = "/data/egyptdj/ukb/nifti/dti_md"
elif args.mri_type == 'flair':
    args.data_dir = "/data/egyptdj/ukb/nifti/flair"
elif args.mri_type == 't1':
    args.data_dir = "/data/egyptdj/ukb/nifti/t1"
else:
